...
def main ():
    ...
    while(True):
        ...
        if(tick >= alert_time):
            tick = 0
            rate_of_change = is_more_than_n_percent_different(deq, 0, max_arr_len-1, 5)
            if(rate_of_change[0]):
